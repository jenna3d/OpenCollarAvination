...
//3.936a variant for Wendy that doesn't give regular updaters, informs user where to get an updater, and get updater button gives current updater
...
string g_sHowToUpdate="I refuse to tell you how to update it though! :P"; //put in appropriate message here.
